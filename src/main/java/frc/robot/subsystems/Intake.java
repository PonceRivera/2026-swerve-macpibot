...
// private final SparkMax deployMotor = new SparkMax(DEPLOY_MOTOR_CAN_ID,
// MotorType.kBrushless);
// private final RelativeEncoder deployEncoder;
// private final SparkClosedLoopController deployPidController;
// private final SparkMax rollerMotor = new SparkMax(ROLLER_MOTOR_CAN_ID,
// MotorType.kBrushless);
// private final SparkMax rollerMotor2 = new SparkMax(ROLLER_MOTOR_2_CAN_ID,
// MotorType.kBrushless);
...
// rollerMotor2.configure(roller2Config, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);
// }
...
// return Math.abs(posiciones[index] - deployEncoder.getPosition()) <
// POSITION_TOLERANCE;
// }
...
// SmartDashboard.putNumber("Intake/Posicion Actual",
